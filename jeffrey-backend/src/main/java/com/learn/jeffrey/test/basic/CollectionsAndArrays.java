...
//        Object aa = a.newInstance(null);
//        Method add = clazz.getDeclaredMethod("add");
//        System.out.println(add.getAnnotatedReturnType());
//        System.out.println(add.equals(1));
//        System.out.println(add.getDeclaredAnnotations());
//        System.out.println(add.getExceptionTypes());
//
